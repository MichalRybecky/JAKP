...
CLASS_COLLECTION_OPEN = pygame.image.load(
    os.path.join(path, "class_collection_open.png")
)
...
INFLUENCERS_SPECIALITY = pygame.image.load(
    os.path.join(path, "influencers_speciality-4.png")
)
INFLUENCERS_SPECIALITY = pygame.transform.scale(
    INFLUENCERS_SPECIALITY, (ICON_SIZE, ICON_SIZE)
)
...
MARSLAKOCSKAK_IMUNACTIV = pygame.image.load(
    os.path.join(path, "marslakocskak_imunactiv-2.png")
)
MARSLAKOCSKAK_IMUNACTIV = pygame.transform.scale(
    MARSLAKOCSKAK_IMUNACTIV, (ICON_SIZE, ICON_SIZE)
)
MARSLAKOCSKAK_INULINNAL = pygame.image.load(
    os.path.join(path, "marslakocskak_inulinnal-2.png")
)
MARSLAKOCSKAK_INULINNAL = pygame.transform.scale(
    MARSLAKOCSKAK_INULINNAL, (ICON_SIZE, ICON_SIZE)
)
